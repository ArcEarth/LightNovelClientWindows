...
namespace LightNovel
{
	...
	public sealed partial class HubPage : Page
	{
		...
		private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
		{
			...
			{
				LoadingIndexTask = ViewModel.LoadSeriesIndexDataAsync();
			}

			LoadingRecentTask = ViewModel.RecentSection.LoadLocalAsync();

			if (!App.Current.IsSignedIn && App.IsConnectedToInternet())
			{
				ViewModel.UserName = "Signing in...";
			...
			if (App.Current.IsSignedIn && !ViewModel.FavoriteSection.IsLoaded && !ViewModel.FavoriteSection.IsLoading && App.IsConnectedToInternet())
			{
			...
			//var indexZoomedOutView = AllSection.GetFirstDescendantOfType<SemanticZoom>().ZoomedOutView as GridView;
			//if (indexZoomedOutView != null)
			//{
			//	indexZoomedOutView.ItemsSource = SeriesIndexViewSource.View.CollectionGroups;
			//}
