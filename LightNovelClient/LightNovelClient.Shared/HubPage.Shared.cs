    ...
    public sealed partial class HubPage : Page
    {
        ...
        private void SyncViewWithOrientation()
        {
            ...
            if (appView.Orientation == ApplicationViewOrientation.Landscape)
            {
                ...
                AppBarHint.Visibility = Visibility.Visible;
            ...
            else
            {
                ...
                AppBarHint.Visibility = Visibility.Collapsed;
        ...
        private async void UserAccount_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (ViewModel.IsSignedIn)
            {
                ...
                menu.Commands.Add(new UICommand(logoutLabel));

                //var elem = (FrameworkElement)sender;
                //GeneralTransform buttonTransform = elem.TransformToVisual(null);
                //Point point = buttonTransform.TransformPoint(new Point());
                //await menu.ShowAsync(point);

                var chosenCommand = await menu.ShowForSelectionAsync(GetElementRect((FrameworkElement)sender));
                if (chosenCommand != null && chosenCommand.Label == logoutLabel)
                {
                    try
                    {
